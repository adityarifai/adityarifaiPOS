...
<body class="a-color fg-white h-vh-100 m4-cloak">
    ...
    <div class="container-fluid start-screen h-100">
        <h1 class="start-screen-title"><a href="{{route('mainmenu')}}"><span style="color: #ffffff;" class="mif-arrow-left icon"></span></a>&nbsp;Inventory</h1>
                ...
                <div data-role="tile" data-size="wide" data-effect="animate-slide-left">
                    <a href="{{route('kategori.all')}}" data-role="tile" class="slide bg-indigo fg-white">
                        <div data-role="tile" class="bg-cyan fg-white" data-size="wide">
                            ...
                            <span class="branding-bar">Configuration</span>
                            <span class="badge-bottom">Configuration of Your Data</span>
                        </div>
                    </a>
                </div>
            </div>
                ...
                <div data-role="tile" data-size="wide" data-effect="animate-slide-left">
                    <a href="{{route('produk.all')}}" data-role="tile" class="slide bg-indigo fg-white">
                        <div data-role="tile" class="bg-green fg-white" data-size="wide">
                            ...
                            <span class="branding-bar">Master Product</span>
                            <span class="badge-bottom">Add & Check Your Product</span>
                        </div>
                    </a>
                </div>
                @endif
